...
export class NewMigration1731957296068 implements MigrationInterface {
    name = 'NewMigration1731957296068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`pedido_venta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`fechaPedido\` date NOT NULL, \`nroComprobante\` int NOT NULL, \`formaPago\` varchar(50) NOT NULL, \`totalPedido\` decimal(10,2) NOT NULL, \`idcliente\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
